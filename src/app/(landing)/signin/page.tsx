          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[500px] rounded-sm bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                ...
                <button className="border-stroke dark:text-body-color-dark dark:shadow-two mb-6 flex w-full items-center justify-center rounded-xs border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-hidden transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none">
                  <span className="mr-3">
                ...
                <form>
                  <div className="mb-8">
                    ...
                    <input
                      ...
                      className="border-stroke dark:text-body-color-dark dark:shadow-two w-full rounded-xs border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-hidden transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
                    />
                  </div>
                  <div className="mb-8">
                    ...
                    <div className="mb-4 sm:mb-0">
                      ...
                      >
                        <div className="relative">
                          ...
                          <div className="box mr-4 flex h-5 w-5 items-center justify-center rounded-sm border border-body-color border-opacity-20 dark:border-white dark:border-opacity-10">
