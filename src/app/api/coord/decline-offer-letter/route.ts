...
export async function POST(req: NextRequest) {
  ...
  try {
    const Body =
      ...
      `We regret to inform you that your offer letter has been declined by your department coordinator for the following reason:\n\n` +
      `"${reason_of_declination}"\n\n` +
      `If you have any questions or need further assistance, please feel free to contact your faculty Supervisor or Coordinator.\n\n` +
      `Department Coordinator Mail ID: ${faculty_mail}\n\n` +
      `Best regards,\n` +
      `CSSI Team`;
