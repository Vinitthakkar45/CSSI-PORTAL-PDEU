import GridShape from '@/components/Landing/Common/GridShape';
...
export default function Error404() {
  return (
    <ThemeProvider>
      <div className="dark:bg-gray-900 relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
        <GridShape />
        ...
        <p className="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400">
          &copy; {new Date().getFullYear()} - CSSI PDEU
        </p>
      </div>
    </ThemeProvider>
  );
