...
export default function UserMetaCard() {
  ...
  return (
    <>
            ...
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              {userData?.info?.profile_image ? (
                <Image
                  ...
                  src={userData.info.profile_image}
                  alt="User Profile"
                />
              ) : (
                <>
      ...
      {error && (
        <div className="p-5 border border-red-200 rounded-2xl mt-4 dark:border-red-800 lg:p-6">
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    <Label>Name</Label>
                    <Input type="text" defaultValue={userData?.info?.name || ''} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Email Address</Label>
                    <Input type="text" defaultValue={userData?.info?.email || ''} />
                  </div>
