...
const StageProgress: React.FC<StageProgressProps> = ({ currentStage, totalStages, handleButtonClick }) => {
      ...
      <div className="lg:flex items-center justify-between gap-20">
        ...
        >
          <Button
            ...
            className={currentStage < 4 ? '' : 'pointer-events-none cursor-not-allowed'}
          >
            Unlock Next Stage
          </Button>
        </div>
