...
const GuidelinesContent = () => {
  return (
    <main className="max-w-5xl mx-auto px-6 py-12 bg-white dark:bg-gray-900 rounded-lg">
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        <h2 className="p-4 mb-4 bg-gray-100 border-l-4 border-l-gray-300 dark:bg-gray-800 dark:text-white text-xl font-bold text-gray-600 sm:text-2xl lg:text-xl xl:text-2xl">
          Preface
        </h2>
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300 mb-4">
        ...
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300 mb-4">
          Students are instructed to read and understand it thoroughly and follow the directions given. Students should
        ...
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300">
          <b>Coordinators:</b> <br />
      ...
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300">
          ...
          futuristic needs. The University has NAAC accreditation with &apos;A++&apos; Grade & CGPA of 3.52 out of 4.00
        </p>
      </section>
      ...
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 text-body-color dark:text-gray-300">
          <li className="mb-2">Civil Engineering</li>
          <li className="mb-2">Mechanical Engineering</li>
          <li className="mb-2">Electronics & Communication Engineering</li>
          <li className="mb-2">Information and Communication Technology</li>
          <li className="mb-2">Computer Science and Engineering</li>
          <li className="mb-2">Computer Science and Business Systems</li>
          <li className="mb-2">BSc Data Science</li>
        </ul>
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300">
          The School emphasizes on integrated development in teaching, research and overall grooming of the students.
          The School has established Science, Engineering and Technology Laboratories, workshops apart from state of the
          art academic, research recreational and residential facilities.
        </p>
      </section>
      ...
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300 mb-4">
          Internship program is a pre-service training designed to render practical experience of a given job. In other
          words employing acquired knowledge hand in hand is called internship. Standard method taken for applying
          knowledge or information is meant &apos;internship&apos;. Formal knowledge increases eagerness to know
          anything and actual application enables an individual to realize the effectiveness and limitations.
        </p>
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300 mb-4">
          An effective internship provide interns with the opportunities to develop an understanding of the career area
          duties and responsibilities, terminology, climate, protocol, and other information that will enable interns to
          analyse and revise their meaningful future plans.
        </p>
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300">
      ...
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300 mb-4">
          ...
          should comprise of at least 20% courses on Humanities and Management. For better execution of policies during
          one&apos;s professional career, a technocrat is required to come to terms with the realities of life. The
          importance of civic and social responsibility is paramount to the success of democracy and promotion of
          dignified living. By engaging in civic responsibility, citizens ensure and uphold certain democratic values
          written in the Constitution. Those values or duties include justice, freedom, equality, diversity, authority,
          privacy, participation, truth, patriotism, human rights, rules of law, tolerance, mutual assistance,
        ...
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300">
          ...
          succor to needy and unprivileged, one comprehends meaning of life and living. By getting their hands dirty and
          actually doing work, students experience the value and impact of giving to people and learn to be productive
          members of society. It also provides an opportunity to the students to integrate technology for solution of
      ...
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color dark:text-gray-300">
          Volunteering is a form of civic responsibility which involves giving of time or labor without the expectation
          of compensation in any form. Many people volunteer through NGOs in several ways. Volunteering allows students
          the opportunity to share their skills and talents as well as to learn new skills while helping those in need
          of assistance. Civic Education is a method to teach civic responsibility. It is a way to promote and enlighten
          responsible citizenry committed to democratic principles. Civic education is a means to actively engage people
          in the practice of democracy. Civic and Social Responsibility is comprised of actions and attitudes associated
          with democratic governance and social participation. Civic responsibility can include participation in
          government, volunteers and memberships of voluntary associations. Actions of civic responsibility can be
          displayed in advocacy for various causes, such as political, economic, civil, and environmental or quality of
          life issues. The students are trained to plan and execute an extensive range of social services, social
          welfare activities, and work in health and philanthropic organizations.
        </p>
      </section>
      ...
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <p className="pr-[10px] text-base italic font-medium leading-relaxed text-body-color dark:text-gray-300 mt-4">
      ...
      <section className="text-gray-700 dark:text-gray-300 mb-8">
        ...
        <ul className="list-disc pl-6 text-base font-medium leading-relaxed text-body-color dark:text-gray-300">
          ...
          <li className="mb-2">Projection of School of Technology and PDEU as a socially responsible organization.</li>
        </ul>
      </section>
    </main>
  );
